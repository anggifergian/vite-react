...
export const mdxComponents = {
  ...
  li: (props: React.ComponentProps<"li">) => <li className="mb-1 text-gray-700" {...props} />,
  ...
  hr: (props: React.ComponentProps<"hr">) => <hr className="my-8 border-t border-gray-50" {...props} />,
};

export default function BlogLayout() {
  return (
    <div className="px-4 md:max-w-[800px] m-auto">
