...
<br/>
In this case, I have domain named 'anggifergian.com' where this blog is served. Example config
```
server {
    listen 80;
    server_name anggifergian.com www.anggifergian.com;

    root /var/www/anggifergian.com;
    index index.html;
